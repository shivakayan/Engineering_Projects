...
static sl_si91x_gpio_pin_config_t sl_gpio_pin_config2 = { { SL_SI91X_GPIO_6_PORT, GPIO_PIN_NUMBER6 }, GPIO_OUTPUT };//pump
static sl_si91x_gpio_pin_config_t sl_gpio_pin_config3 = { { SL_SI91X_GPIO_12_PORT, GPIO_PIN_NUMBER12 }, GPIO_OUTPUT };//fan
static sl_si91x_gpio_pin_config_t sl_gpio_pin_config4 = { { SL_SI91X_GPIO_7_PORT, GPIO_PIN_NUMBER7 }, GPIO_OUTPUT };//humidifier
/*******************************************************************************
